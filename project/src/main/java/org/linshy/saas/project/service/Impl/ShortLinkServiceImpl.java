...
import org.linshy.saas.project.common.convention.exception.ClientException;
...
import org.linshy.saas.project.config.GotoDomainWhiteListConfiguration;
...
import org.linshy.saas.project.mq.producer.ShortLinkStatsSaveProducer;
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(hasShortLinkDO.getGid(), requestParam.getGid())) {
            LambdaUpdateWrapper<ShortLinkDO> updateWrapper = Wrappers.lambdaUpdate(ShortLinkDO.class)
                    ...
                    .eq(ShortLinkDO::getDelFlag, 0)
                    .eq(ShortLinkDO::getEnableStatus, 0)
                    .set(Objects.equals(requestParam.getValidDateType(), VaildDataTypeEnum.PERMANENT.getType()),
            ...
            ShortLinkDO shortLinkDO = ShortLinkDO.builder()
                    ...
                    .gid(requestParam.getGid())
                    .originUrl(hasShortLinkDO.getOriginUrl())
                    .describe(requestParam.getDescribe())
                    .validDateType(requestParam.getValidDateType())
                    .validDate(requestParam.getValidDate())
                    .build();
            ...
            try {
//                // 删除原链接
                baseMapper.delete(requestParam.getOriginGid(),requestParam.getFullShortUrl(),System.currentTimeMillis());
                // 新增新链接
                ShortLinkDO shortLinkDO = ShortLinkDO.builder()
                        .domain(createShortLinkDefaultDomain)
                        .originUrl(hasShortLinkDO.getOriginUrl())
                        ...
                        .favicon(getFavicon(hasShortLinkDO.getOriginUrl()))
                        .delTime(0L)
                        .build();
                baseMapper.insert(shortLinkDO);
